defmodule BetterFormsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BetterFormsWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BetterFormsWeb.Gettext, "errors", msg, opts)
    end
  end
