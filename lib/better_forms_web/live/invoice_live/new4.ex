defmodule BetterFormsWeb.InvoiceLive.New4 do
  @moduledoc """
  Fourth example of form validation patterns

  Relative to V3, we:

  + Validate a little bit better
  + Make use of the <.input> elements

  Issues we still have:

  + Still validate uniqueness of invoice number on every change
  + Dirty/Clean state isn't quite right
  + Still using amount_in_cents instead of something friendlier
  """
